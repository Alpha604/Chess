...
function updateStats(stats) {
    ...
    document.getElementById('won').textContent = "Gagné :" + stats.won;

    document.getElementById('number-won').textContent = "Null :" + stats.won;

    document.getElementById('draw').style.width = (stats.draw / total * 100) + "%";
    document.getElementById('draw').textContent = stats.draw;

    document.getElementById('number-draw').textContent = "Perdu :" + stats.draw
