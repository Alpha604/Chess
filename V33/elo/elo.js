document.addEventListener('DOMContentLoaded', async () => {
    ...
    setTimeout(async () => {
        ...
        const botNum = params.get('num')?.toString() || "1"; // forcer en string
        const botEloParam = params.get('elo'); // on peut utiliser si besoin
        ...
        try {
            ...
            document.getElementById('bot-elo').textContent = `Elo : ${botEloParam || bot.elo}`;
